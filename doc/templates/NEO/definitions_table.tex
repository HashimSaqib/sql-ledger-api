%%% This package produces the item table %%%
...
% If you create an article that with an arcticle number "Titel", then this article acts as a subtitle on the invoice, leaving all fields blank except the description field (which then acts as the subtitle.
